...
CREATE TABLE "UserEventsFile" (
    ...
    CONSTRAINT "UserEventsFile_pkey" PRIMARY KEY ("cId")
);
...
-- AddForeignKey
ALTER TABLE "UserEventsFileHostCount" ADD CONSTRAINT "UserEventsFileHostCount_cId_fkey" FOREIGN KEY ("cId") REFERENCES "UserEventsFile"("cId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_HostToUserEventsFile" ADD CONSTRAINT "_HostToUserEventsFile_B_fkey" FOREIGN KEY ("B") REFERENCES "UserEventsFile"("cId") ON DELETE CASCADE ON UPDATE CASCADE;
